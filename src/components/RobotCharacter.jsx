...
function RobotCharacter({ className = "" }) {
  return (
    ...
    >
      <defs>
        <linearGradient id="akRobotHead" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#F6F1E7" />
          <stop offset="100%" stopColor="#DDD3C2" />
        </linearGradient>
        <linearGradient id="akRobotBody" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#EFE9DC" />
          <stop offset="100%" stopColor="#CFC4B0" />
        </linearGradient>
        <radialGradient id="akRobotGlow" cx="50%" cy="50%" r="50%">
        ...
        <filter id="akRobotSoftGlow" x="-60%" y="-60%" width="220%" height="220%">
      ...
      <g className="robot-float">
        ...
        <circle cx="150" cy="170" r="125" fill="url(#akRobotGlow)" />
        ...
        <g className="robot-antenna robot-antenna-left">
          ...
          <circle cx="109" cy="33" r="7" fill="#F6F1E7" stroke="#22b8f0" strokeWidth="2.5" filter="url(#akRobotSoftGlow)" />
        </g>
        <g className="robot-antenna robot-antenna-right">
          ...
          <circle cx="191" cy="33" r="7" fill="#F6F1E7" stroke="#56d4ff" strokeWidth="2.5" filter="url(#akRobotSoftGlow)" />
        </g>

        {/* TORSO */}
        <rect x="88" y="190" width="124" height="120" rx="54" fill="url(#akRobotBody)" />
        <rect x="118" y="208" width="64" height="76" rx="22" fill="#E8DCC8" />
        <circle className="robot-chest-glow" cx="150" cy="246" r="15" fill="#22b8f0" filter="url(#akRobotSoftGlow)" />

        {/* NECK */}
        <rect x="137" y="180" width="26" height="18" fill="#E2D9C8" />

        {/* HEAD */}
        <rect x="82" y="66" width="136" height="120" rx="44" fill="url(#akRobotHead)" />
        ...
        <g className="robot-eyes">
          <rect x="121" y="117" width="20" height="25" rx="8" fill="#7fe3ff" filter="url(#akRobotSoftGlow)" />
          <rect x="159" y="117" width="20" height="25" rx="8" fill="#7fe3ff" filter="url(#akRobotSoftGlow)" />
        </g>
